// Letterboxd parsing — shared by the browser and the sync worker.
//
// This file exists in src/lib rather than scripts/lib because BOTH need it: the
// nightly worker reads your RSS feed on a runner, and the CSV import runs in the
// browser off a file you picked. Two copies of a parser is two parsers, and the
// one nobody is looking at is the one that rots — this project has already paid
// for that lesson twice (portfolio totals, media reads).
//
